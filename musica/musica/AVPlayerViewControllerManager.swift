...
@objcMembers class AVPlayerViewControllerManager: NSObject {
	...
	public var lowQualityMode = true
    ...
    fileprivate func updatePlaybackRateMetadata() {
        ...
        if nowRate == 1.0 {
            ...
            nowPlayingInfo[MPNowPlayingInfoPropertyPlaybackRate] = nowRate
            nowPlayingInfo[MPNowPlayingInfoPropertyDefaultPlaybackRate] = nowRate
        }
    }
}
